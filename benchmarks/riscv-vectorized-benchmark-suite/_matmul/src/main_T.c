...
extern void matrixmul_intrinsics(data_t *a, data_t *b, data_t *c, data_t *b_T, int n, int m, int p) ;
...
int main (int argc, char **argv)
{
    ...
    data_t *M2_T = (data_t*)malloc(K*N*sizeof(data_t));
    ...
    matrixmul_intrinsics(M1, M2, result, M2_T, N, M, K);
